...
https://nats-io.github.io/nats.py/ //set up back
https://github.com/nats-io/nats.ws //set up front
...
gunicorn test_project.asgi:application -w 4 -k test_project.custom_uvicorn_worker.UvicornWorker
